...
class MenuViewController: UIViewController, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        getInfo()
        editName.addTarget(self, action: #selector(MenuViewController.edit_name(_:)), for: .touchUpInside)
        editPassword.addTarget(self, action: #selector(MenuViewController.edit_password(_:)), for: .touchUpInside)
