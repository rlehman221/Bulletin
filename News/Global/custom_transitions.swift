...
class UIStoryboardSegueFromRight: UIStoryboardSegue
{
    override func perform() {
        ...
        let navcontrol = src.navigationController
        navcontrol?.popToViewController(dst, animated: false)
        navcontrol?.pushViewController(dst, animated: true)
...
class UIStoryboardSegueFrom_MenuItem_To_Menu_Left: UIStoryboardSegue
{
    override func perform() {
        ...
        UIApplication.shared.delegate?.window??.rootViewController = dst
...
class UIStoryboardSegueNormalRight: UIStoryboardSegue
{
    override func perform() {
        let src = self.source as UIViewController
        let dst = self.destination as UIViewController
